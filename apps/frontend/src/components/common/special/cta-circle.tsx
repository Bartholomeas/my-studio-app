...
export const CtaCircle = ({
	className,
	text = "Scrolluj w dół, aby dowiedzieć się więcej",
	...props
}: CtaCircleProps) => {
	return (
		<motion.button
			className={cn(
				"group grid aspect-square size-[120px] place-content-center rounded-full transition-colors duration-700 ease-out md:size-[200px]",
				className,
			)}
			{...props}
		>
