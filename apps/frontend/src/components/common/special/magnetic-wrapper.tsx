...
import { motion, type SpringOptions, useMotionValue, useSpring, type MotionProps, useMotionTemplate } from "framer-motion";
...
export const MagneticWrapper = ({
  ...
  return <motion.div
    ...
    className={cn('relative p-[24px] h-fit w-fit flex items-center justify-center duration-700 ease-out', className)}
    {...props}>
    {children}
  </motion.div >;
};