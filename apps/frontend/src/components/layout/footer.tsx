      ...
      <div className={"relative bottom-0 top-[-100vh] h-[calc(100vh+650px)] w-full bg-primary-400"}>
        ...
        >
          <div className={"flex items-center gap-4"}>
            <Logo />
            <Text weight={'bold'} size={"lg"} className={"text-primary-900"}>{t('slogan')}</Text>
          </div>
          <div className={"flex flex-wrap gap-8 pt-8"}>
            <div className={"flex flex-col gap-2"}>
              <Title className={"text-primary-900"} weight={'bold'}>{t('fastLinks.heading')}</Title>
            ...
            <div className={"flex flex-col gap-2"}>
              <Title className={"text-primary-900"} weight={'bold'}>{t('restrictions.heading')}</Title>
              <MagneticWrapper className={"p-0"}>
            ...
            <div className={"flex flex-col gap-2"}>
              <Title className={"text-primary-900"} weight={'bold'}>{t('socials.heading')}</Title>
              <MagneticWrapper className={"p-0"}>
