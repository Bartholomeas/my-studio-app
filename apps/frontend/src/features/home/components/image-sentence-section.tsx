...
import { useScrollProgressContext } from "@/features/common/components/animations/context/scroll-progress-context";
  ...
  return (
    ...
    >
      <motion.div
        style={{ y }}
        className={
          "relative col-span-12 h-full overflow-hidden  md:col-span-5 md:row-span-5"
        }
      >
        <Image
          src={BackgroundImage}
      ...
      <motion.div
        style={{ y: y2 }}
        className={
          "relative col-span-12 h-full overflow-hidden  bg-background p-8 md:col-span-7 md:row-span-2"
        }
      >
      ...
      <div className={"col-span-12 grid grid-cols-12 gap-4 md:col-span-7 md:row-span-6"}>
        <motion.div
          style={{ y: y3 }}
          className={
            "relative col-span-12 row-span-5 h-full overflow-hidden  bg-primary md:col-span-7"
          }
        ></motion.div>
        <motion.div
          style={{ y: y4 }}
          className={
            "relative col-span-12 h-full overflow-hidden  bg-background-dark md:col-span-5 md:row-span-3"
          }
        ></motion.div>
      </div>
    </section>
